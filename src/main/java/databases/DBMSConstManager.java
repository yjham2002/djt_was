 ...
 * Jul-21-2017
 */
public class DBMSConstManager {

    protected Connection connection = null;
    protected Statement st = null;

    public static final String USERNAME = "hit_talk";
    public static final String PASSWORD = "#talk1209#";
    public boolean autoConnect = true;

    public String getConnectionInfo(){
        return "jdbc:sqlserver://210.125.136.17:1433;databaseName=DHDB";
    }
