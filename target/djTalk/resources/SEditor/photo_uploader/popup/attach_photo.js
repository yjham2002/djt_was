    ...
    function html5Upload() {	
    	var tempFile,
    		sUploadURL;
    	sUploadURL= '/TheLounge/ApiCommon/imgUploadSEditor'; 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		...
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
			...
			sUrl  : '/TheLounge/ApiCommon/imgUploadSEditor',	//샘플 URL입니다.
			sCallback : '/TheLounge/resources/SEditor/photo_uploader/popup/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
	 ...
	 */
 	function setPhotoToEditor(oFileInfo){
		if (!!opener && !!opener.nhn && !!opener.nhn.husky && !!opener.nhn.husky.PopUpManager) {
			...
			var imgTag = '<img src="' + oFileInfo[0]["sFileURL"] + '" width="100%"/> <br style="clear:both;">';
